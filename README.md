...
| [`@financica/camt053`](packages/camt053)                               | 0.2.0   | ISO 20022 CAMT.053 (Bank-to-Customer Statement) XML parser                                            |
...
| [`@financica/facturx`](packages/facturx)                               | 0.1.1   | Factur-X / ZUGFeRD (EN 16931 CII) hybrid e-invoices: parse, generate, embed in PDF/A-3                |
...
| [`@financica/stripe-ubl`](packages/stripe-ubl)                         | 1.3.0   | Convert Stripe invoices and credit notes into Peppol BIS Billing 3.0 UBL                              |
| [`@financica/ubl`](packages/ubl)                                       | 0.15.1  | UBL invoice toolkit — parse, build and serialize Peppol BIS Billing 3.0                               |
